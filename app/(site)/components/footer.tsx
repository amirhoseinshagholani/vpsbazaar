            ...
            <footer className="p-10 pb-1">
                <div className="grid grid-cols-12 p-10 flex text-white text-sm">
                    ...
                    <div className="col-span-6 md:col-span-3 vazirfont-regular flex justify-end md:justify-center mt-10 md:mt-0">
                        <div>
                             <a referrerPolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=595338&Code=fLDmoWo8U7nFk9Xn7HIMaU3CpJrrEwvo'><img referrerPolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=595338&Code=fLDmoWo8U7nFk9Xn7HIMaU3CpJrrEwvo' alt='' style={{ cursor: 'pointer' }} code='fLDmoWo8U7nFk9Xn7HIMaU3CpJrrEwvo'/></a>
                        </div>
                    </div>
                </div>
