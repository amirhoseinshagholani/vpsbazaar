                    ...
                    <div className="p-10 grid grid-cols-12">
                        <div className="col-span-12 md:col-span-6 mt-10">
                            ...
                            <ul className="text-sm md:text-lg  vazirfont-bold mb-3 mt-3 text-gray-700">
                                <li className="mt-1"> اختصاصی مثل CPU، RAM و فضای ذخیره‌سازی دارید</li>
                                <li className="mt-1"> کامل به سیستم‌عامل و نصب نرم‌افزار دلخواه</li>
                                <li className="mt-1"> وابستگی به دیگر کاربران سرور</li>
                            </ul>
